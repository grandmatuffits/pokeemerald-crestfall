...
const u8 gText_DexHoennTitle[] = _("ENPALE DEX");
...
const u8 gText_DexHoennDescription[] = _("ENPALE region's POKéDEX");
...
const u8 gText_BerriesHeldItemsOnly[] = _("Berries can only be used\nas held items.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DexHoenn[] = _("ENPALE");
