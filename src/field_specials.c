...
static const struct SafariBounty sSafariBounties[] =
{
    ...
    { BOUNTY_TYPE,    TYPE_POISON },
    { BOUNTY_TYPE,    TYPE_FIGHTING },
    { BOUNTY_TYPE,    TYPE_GHOST },
    { BOUNTY_TYPE,    TYPE_DARK },
    { BOUNTY_TYPE,    TYPE_WATER },
    { BOUNTY_TYPE,    TYPE_PSYCHIC },
    { BOUNTY_TYPE,    TYPE_GROUND },
    { BOUNTY_TYPE,    TYPE_ROCK },
    { BOUNTY_TYPE,    TYPE_STEEL },
    { BOUNTY_TYPE,    TYPE_ICE },
    { BOUNTY_TYPE,    TYPE_DRAGON },
    { BOUNTY_SPECIES, SPECIES_PIDGEY },
    { BOUNTY_SPECIES, SPECIES_CATERPIE },
    { BOUNTY_SPECIES, SPECIES_BELLSPROUT },
    { BOUNTY_SPECIES, SPECIES_PIKIPEK },
    { BOUNTY_SPECIES, SPECIES_NYMBLE },
    { BOUNTY_SPECIES, SPECIES_SKIDDO },
    { BOUNTY_SPECIES, SPECIES_SWABLU },
    { BOUNTY_SPECIES, SPECIES_MUDBRAY },
    { BOUNTY_SPECIES, SPECIES_CUBONE },
    { BOUNTY_SPECIES, SPECIES_PHANPY },
    { BOUNTY_SPECIES, SPECIES_GOLETT },
    { BOUNTY_SPECIES, SPECIES_MANKEY },
    { BOUNTY_SPECIES, SPECIES_ONIX },
    { BOUNTY_SPECIES, SPECIES_GLIMMET },
    { BOUNTY_SPECIES, SPECIES_INKAY },
    { BOUNTY_SPECIES, SPECIES_SLOWPOKE },
    { BOUNTY_SPECIES, SPECIES_TYMPOLE },
    { BOUNTY_SPECIES, SPECIES_DUSKULL },
    { BOUNTY_SPECIES, SPECIES_WINGULL },
    { BOUNTY_SPECIES, SPECIES_WAILMER },
    { BOUNTY_SPECIES, SPECIES_REMORAID },
    { BOUNTY_SPECIES, SPECIES_SPHEAL },
};
