...
{
    {COMPOUND_STRING("TM75{CLEAR_TO 0x48}4,000 COINS")},
    {COMPOUND_STRING("TM98{CLEAR_TO 0x48}4,000 COINS")},
    {COMPOUND_STRING("TM04{CLEAR_TO 0x48}4,000 COINS")},
    {COMPOUND_STRING("TM23{CLEAR_TO 0x48}4,000 COINS")},
    {gText_Exit},
};
