...
static const u8 sMapHealLocations[][3] =
{
    ...
    [MAPSEC_PALLET_TOWN] = {MAP_GROUP(MAP_KINNERET_TOWN), MAP_NUM(MAP_KINNERET_TOWN), HEAL_LOCATION_KINNERET_TOWN},
    [MAPSEC_VIRIDIAN_CITY] = {MAP_GROUP(MAP_VALERYTOWN), MAP_NUM(MAP_VALERYTOWN), HEAL_LOCATION_VALERYTOWN},
    [MAPSEC_PEWTER_CITY] = {MAP_GROUP(MAP_QUARREN_TOWN), MAP_NUM(MAP_QUARREN_TOWN), HEAL_LOCATION_QUARREN_TOWN},
    [MAPSEC_CERULEAN_CITY] = {MAP_GROUP(MAP_VELDTMOOR_CITY), MAP_NUM(MAP_VELDTMOOR_CITY), HEAL_LOCATION_VELDTMOOR_CITY},
    [MAPSEC_LAVENDER_TOWN] = {MAP_GROUP(MAP_COPPERGATE_CITY), MAP_NUM(MAP_COPPERGATE_CITY), HEAL_LOCATION_COPPERGATE_CITY},
    [MAPSEC_VERMILION_CITY] = {MAP_GROUP(MAP_LENOX_TOWN), MAP_NUM(MAP_LENOX_TOWN), HEAL_LOCATION_LENOX_TOWN},
    [MAPSEC_CELADON_CITY] = {MAP_GROUP(MAP_DELMARK_CITY_WEST), MAP_NUM(MAP_DELMARK_CITY_WEST), HEAL_LOCATION_DELMARK_CITY_WEST},
    [MAPSEC_FUCHSIA_CITY] = {MAP_GROUP(MAP_ROSEBANK_TOWN), MAP_NUM(MAP_ROSEBANK_TOWN), HEAL_LOCATION_ROSEBANK_TOWN},
    [MAPSEC_CINNABAR_ISLAND] = {MAP_GROUP(MAP_MIRAVEIL_ISLAND), MAP_NUM(MAP_MIRAVEIL_ISLAND), HEAL_LOCATION_MIRAVEIL_ISLAND},
    [MAPSEC_INDIGO_PLATEAU] = {MAP_GROUP(MAP_BAYNOE_TOWN), MAP_NUM(MAP_BAYNOE_TOWN), HEAL_LOCATION_BAYNOE_TOWN},
    [MAPSEC_SAFFRON_CITY] = {MAP_GROUP(MAP_MINSI_CITY), MAP_NUM(MAP_MINSI_CITY), HEAL_LOCATION_MINSI_CITY},
